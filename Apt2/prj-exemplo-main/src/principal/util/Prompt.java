...
/**
 * Um classe utilitária para imprimir e ler textos, 
 * números inteiros e decimais no prompt de comandos.
 * 
...
public class Prompt {
	...
	/**
	 * Imprime a mensagem enviada, faz a leitura do texto digitado no prompt
	 * de comandos e retorna uma String no formato ISO-8859-1 Latin ou UTF-8.
	 * 
	 * @return String
	 */
	...
	/**
	 * Imprime a mensagem enviada, faz a leitura do número digitado 
	 * no prompt de comandos e retorna um int.
	 * 
	 * @return int
	 */
	...
	/**
	 * Imprime a mensagem enviada, faz a leitura do número digitado 
	 * no prompt de comandos e retorna um double.
	 * 
	 * @return double
	 */
	...
	/**
	 * Faz uma pausa no processamento e pede para o usuário pressionar enter para continuar.
	 */
